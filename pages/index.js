    ...
    <Layout home>
      ...
      <section className="space-y-4 font-sans text-justify text-gray-800 px-4">
        <p className="text-lg">
          ...
          Economics. I have a strong interest in the intersection of technology
          and business.
        </p>
        <small className="text-sm block mb-2">
          PS : Coffee, travel and gym addict
        </small>
        ...
        <ul className="text-base list-none">
          {allPostsData.map(({ id, date, title }) => (
            <li
              className="py-3 border-b border-gray-300 last:border-0 hover:text-cyan-700"
              key={id}
            >
              <Link href={`/posts/${id}`}>
